...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* ===== HEADER ===== */}
      <header className="sticky top-0 z-50 h-16 w-full border-b border-white/10 bg-[#0B0B0B] font-chakra text-gray-200 backdrop-blur-md">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-16 z-40 overflow-y-auto bg-black/95 backdrop-blur-sm md:hidden"
          >
            <div className="container mx-auto flex flex-col items-end gap-6 px-4 py-8 font-chakra">
              <button
        ...
        {isBetaDialogOpen && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-lg rounded-xl border border-white/10 bg-[#181818] p-8 font-chakra shadow-2xl"
            >
              <div className="text-center">
                ...
                <p className="mb-8 text-sm leading-relaxed font-chakra text-gray-300">
                ...
                <div className="flex justify-center">
                  <Button
                    onClick={() => setIsBetaDialogOpen(false)}
                    className="bg-purple-600 font-chakra hover:bg-purple-500"
                  >
                    Close 
                  </Button>
                </div>
        ...
        {isHowToPlayDialogOpen && (
          ...
          >
            <motion.div
              ...
              exit={{ scale: 0.95, opacity: 0 }}
              onClick={(e) => e.stopPropagation()}
              className="flex max-h-[85vh] w-full max-w-xl flex-col overflow-hidden rounded-xl border border-white/10 bg-[#181818] font-chakra shadow-2xl"
            >
              {/* Modal Header */}
