     ...
     <motion.div
        ...
        >
          <Image
            ...
            width={800}
            height={500}
            className="object-contain w-[80%] lg:w-[100%]"
            loading="lazy"
          />
        </motion.div>
        {/* Grid Layout (Always 3 Columns) */}
        <div className="relative grid grid-cols-4 gap-x-4 sm:gap-x-10 md:gap-x-20 lg:gap-x-28 gap-y-6 sm:gap-y-8 w-full max-w-7xl z-20">
