    ...
    <section className="w-full min-h-screen -mt-auto mb-8 bg-[#1C1C1C]/90 bg-[url('/assets/pattern-bg.png')] bg-cover bg-no-repeat bg-center bg-blend-multiply p-4 sm:p-6">
      ...
      <div className="container py-12 sm:py-16 lg:py-24 mx-auto flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
        ...
        <motion.div
          ...
          {...fadeUp(0.1)}
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl py-4 px-2 lg:px-0 mb-4 tracking-tight font-bold text-white font-chakra leading-snug uppercase">
          ...
          <p className="text-sm sm:text-base md:text-lg font-normal text-white font-chakra max-w-xl mx-auto lg:mx-0">
            His pass serves as a platform to store and redeem rewards, such as
            ...
            preserving a player's on-chain achievements indefinitely. Only Black
            Pass holders will have access to claim the upcoming $DDX Airdrop.
          </p>
        </motion.div>
        ...
        >
          <motion.h1
            className="text-6xl sm:text-7xl md:text-8xl lg:text-[180px] xl:text-[220px] bg-gradient-to-tr from-[#004AAD] via-[#665BC9] to-[#CB6CE6] bg-clip-text text-transparent font-extrabold font-chakra"
          ...
          >
            <Image
              ...
              width={350}
              height={350}
              className="w-[180px] sm:w-[220px] md:w-[280px] lg:w-[350px] h-auto"
            />
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="w-full container mt-12">
        <motion.h2
          className="text-xl sm:text-2xl md:text-3xl font-bold uppercase text-white font-chakra tracking-tight text-center mb-10"
          {...fadeUp(0.2)}
        >
          How to get the Black Pass
        </motion.h2>

        <div className="flex flex-col md:flex-row w-full md:max-w-[950px] px-4 sm:px-8 md:px-12 mx-auto gap-8 md:gap-6 lg:gap-12 justify-center text-white items-stretch">
          {/* Step 1 */}
          <motion.div
            className="flex gap-3 flex-col w-full md:max-w-[220px] items-center text-center"
            {...fadeUp(0.3)}
          >
            <Image
          ...
          >
            ...
            <p className="text-sm sm:text-base font-normal tracking-tight leading-5 font-chakra">
              Black Pass is a non-transferable Soulbound Token (SBT) associated
              with your wallet and will be forever in your wallet.
            </p>
          </motion.div>
