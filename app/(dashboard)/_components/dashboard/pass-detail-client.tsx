...
import PassActionButton from "../PassActionButton";
            ...
            <div className='flex gap-4 items-center w-full max-w-6xl px-6 justify-between'>
              <div>
                <ul className='text-lg font-medium'>
                  ...
                  <li className='flex gap-2'>  <Check size={24} color='white'/> Earn {pass.point_power}x points on interactions</li>
                </ul>
              </div>
              <div className='flex flex-col items-center gap-8'>
                <p className="">{pass.pass_type}</p>
                <Image src={pass.card} alt='pass' width={380} height={270}/>
                <p className="text-md tracking-tight capitalize">{pass.name}</p>
                <p className=" text-xl font-bold">${pass.usd_price}</p>
